...
def run_fortigate_backup(
  ...
  try:
    api_client.report_step(device_id=device.device_id, execution_id=execution_id, step_key="start_automation", status="success", detail=None, meta={"vendor": "fortigate"})
    if psutil:
      p = psutil.Process()
